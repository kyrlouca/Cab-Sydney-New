...
procedure TM_portFRM1.BitBtn2Click(Sender: TObject);
begin
close;
end;

procedure TM_portFRM1.TableSQLBeforeEdit(
  DataSet: TDataSet);
begin
...
procedure TM_portFRM1.TableSRCStateChange(Sender: TObject);
begin
...
procedure TM_portFRM1.FormKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TM_portFRM1.TableSQLAfterInsert(DataSet: TDataSet);
begin
...
procedure TM_portFRM1.FormActivate(Sender: TObject);
begin
...
procedure TM_portFRM1.FormClose(Sender: TObject;
...
procedure TM_portFRM1.CanelBTNClick(Sender: TObject);
begin
TableSQL.Cancel;
close;
end;
