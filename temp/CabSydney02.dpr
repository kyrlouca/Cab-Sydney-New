...
uses
  ...
  I_ReadTariffKeys in 'SRC\I_ReadTariffKeys.pas' {I_ReadTariffKeysFRM},
  ...
  R_UnclearedHawbs in 'SRC\R_UnclearedHawbs.pas' {R_UnclearedHawbsFRM},
...
//      Destination.LogFile.FilePath := 'C:\Users\KyrLouca\Desktop\dem\';
  ...
  Application.CreateForm(TM_portFRM, M_portFRM);
  Application.CreateForm(TU_CountryFRM, U_CountryFRM);
