...
type
  TM_CustomerNewFRM = class(TForm)
    ...
    Label14: TLabel;
    wwDBEdit1: TwwDBEdit;
    CustomerSQLCONTACT_NAME: TStringField;
    Label19: TLabel;
    ContactNameFLD: TDBEdit;
    CustomerSQLIS_SHOWN: TStringField;
    ActiveFLD: TRzDBCheckBox;
    ...
    procedure CustomerSQLAfterScroll(DataSet: TDataSet);
    procedure ActiveFLDClick(Sender: TObject);
  private
...
procedure TM_CustomerNewFRM.ActiveFLDClick(Sender: TObject);
begin
var xx :=     activeFLD.Checked;
