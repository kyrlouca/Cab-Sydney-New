object B_BucketHawbItemFRM4: TB_BucketHawbItemFRM4
  Left = 236
  Top = 130
  ...
  object HiCertificateSQL: TIBCQuery
    ...
    UpdateTransaction = WriteTrans
    SQL.Strings = (
      'Select * From Bucket_hawb_item_certificate')
    MasterFields = 'SERIAL_NUMBER'
    DetailFields = 'FK_HAWB_ITEM'
    MasterSource = HawbItemSrC
    Left = 560
  ...
  object HawbItemSQL: TIBCQuery
    ...
    SQL.Strings = (
      ...
      'left outer  join  Bucket_sender_invoice si'
