object B_XmlFilesUploadedFRM: TB_XmlFilesUploadedFRM
  Left = 0
  Top = 303
  Caption = 'Instructor'
  ClientHeight = 689
  ...
  object Panel3: TPanel
    ...
    object BottomPNL: TRzPanel
      ...
      object Grid1: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'HAWB_ID'#9'24'#9'Hawb Id'#9#9
          'ITEM_MESSAGE'#9'172'#9'Error Message'#9'F')
    ...
    object TopPnl: TPanel
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Selected.Strings = (
          'SERIAL_NUMBER'#9'8'#9'S/N'#9#9
          'FLIGHT_NUMBER'#9'10'#9'Flight'#9#9
          'DEPARTURE_TIMESTAMP'#9'18'#9'Departure'#9#9
          'FILE_NAME'#9'62'#9'File Name'#9'F'#9
          'HEADER_TIMESTAMP'#9'20'#9'Timestamp'#9#9
          'LOADED_TIMESTAMP'#9'25'#9'Uploaded Time'#9#9
          'HAWBS_TOTAL'#9'10'#9'Recs'
          'HAWBS_SUCCESS'#9'10'#9'Loaded'
          'HAWBS_PARTIAL'#9'10'#9'Partial'
          'HAWBS_FAILED'#9'10'#9'Failed'
          'HAWBS_REPEAT'#9'10'#9'Repeat')
        IniAttributes.Delimiter = ';;'
        IniAttributes.UnicodeIniFile = False
        TitleColor = clBtnFace
        FixedCols = 0
  ...
  object TableSQL: TIBCQuery
    ...
    KeyGenerator = 'GEN_XML_FILE_INFO_ID'
    SQLInsert.Strings = (
      'INSERT INTO XML_FILE_INFO'
      
        '  (SERIAL_NUMBER, FILE_NAME, HEADER_TIMESTAMP, LOADED_TIMESTAMP,' +
        ' DEPARTURE_TIMESTAMP, FLIGHT_NUMBER, HAWBS_TOTAL, HAWBS_SUCCESS,' +
        ' HAWBS_FAILED, HAWBS_PARTIAL, HAWBS_REPEAT)'
      'VALUES'
      
        '  (:SERIAL_NUMBER, :FILE_NAME, :HEADER_TIMESTAMP, :LOADED_TIMEST' +
        'AMP, :DEPARTURE_TIMESTAMP, :FLIGHT_NUMBER, :HAWBS_TOTAL, :HAWBS_' +
        'SUCCESS, :HAWBS_FAILED, :HAWBS_PARTIAL, :HAWBS_REPEAT)')
    SQLDelete.Strings = (
      'DELETE FROM XML_FILE_INFO'
      'WHERE'
      '  SERIAL_NUMBER = :Old_SERIAL_NUMBER')
    SQLUpdate.Strings = (
      'UPDATE XML_FILE_INFO'
      'SET'
      
        '  SERIAL_NUMBER = :SERIAL_NUMBER, FILE_NAME = :FILE_NAME, HEADER' +
        '_TIMESTAMP = :HEADER_TIMESTAMP, LOADED_TIMESTAMP = :LOADED_TIMES' +
        'TAMP, DEPARTURE_TIMESTAMP = :DEPARTURE_TIMESTAMP, FLIGHT_NUMBER ' +
        '= :FLIGHT_NUMBER, HAWBS_TOTAL = :HAWBS_TOTAL, HAWBS_SUCCESS = :H' +
        'AWBS_SUCCESS, HAWBS_FAILED = :HAWBS_FAILED, HAWBS_PARTIAL = :HAW' +
        'BS_PARTIAL, HAWBS_REPEAT = :HAWBS_REPEAT'
      'WHERE'
      '  SERIAL_NUMBER = :Old_SERIAL_NUMBER')
    SQLRefresh.Strings = (
      
        'SELECT SERIAL_NUMBER, FILE_NAME, HEADER_TIMESTAMP, LOADED_TIMEST' +
        'AMP, DEPARTURE_TIMESTAMP, FLIGHT_NUMBER, HAWBS_TOTAL, HAWBS_SUCC' +
        'ESS, HAWBS_FAILED, HAWBS_PARTIAL, HAWBS_REPEAT FROM XML_FILE_INF' +
        'O'
      'WHERE'
      '  SERIAL_NUMBER = :SERIAL_NUMBER')
    SQLLock.Strings = (
      'SELECT NULL FROM XML_FILE_INFO'
      'WHERE'
      'SERIAL_NUMBER = :Old_SERIAL_NUMBER'
      'FOR UPDATE WITH LOCK')
    SQLRecCount.Strings = (
      'SELECT COUNT(*) FROM ('
      'SELECT 1 AS C  FROM XML_FILE_INFO'
      ''
      ') q')
    ...
    object TableSQLFLIGHT_NUMBER: TStringField
      DisplayLabel = 'Flight'
      DisplayWidth = 10
      FieldName = 'FLIGHT_NUMBER'
      Size = 10
    end
    object TableSQLDEPARTURE_TIMESTAMP: TDateTimeField
      DisplayLabel = 'Departure'
      DisplayWidth = 18
      FieldName = 'DEPARTURE_TIMESTAMP'
    end
    object TableSQLFILE_NAME: TStringField
      DisplayLabel = 'File Name'
      DisplayWidth = 62
      FieldName = 'FILE_NAME'
      Size = 1000
    end
    object TableSQLHEADER_TIMESTAMP: TDateTimeField
      DisplayLabel = 'Timestamp'
      DisplayWidth = 20
      FieldName = 'HEADER_TIMESTAMP'
    end
    object TableSQLLOADED_TIMESTAMP: TDateTimeField
      DisplayLabel = 'Uploaded Time'
      DisplayWidth = 25
      FieldName = 'LOADED_TIMESTAMP'
    end
    object TableSQLHAWBS_TOTAL: TIntegerField
      DisplayLabel = 'Recs'
      DisplayWidth = 10
      FieldName = 'HAWBS_TOTAL'
    end
    object TableSQLHAWBS_SUCCESS: TIntegerField
      DisplayLabel = 'Loaded'
      DisplayWidth = 10
      FieldName = 'HAWBS_SUCCESS'
    end
    object TableSQLHAWBS_PARTIAL: TIntegerField
      DisplayLabel = 'Partial'
      DisplayWidth = 10
      FieldName = 'HAWBS_PARTIAL'
    end
    object TableSQLHAWBS_FAILED: TIntegerField
      DisplayLabel = 'Failed'
      DisplayWidth = 10
      FieldName = 'HAWBS_FAILED'
    end
    object TableSQLHAWBS_REPEAT: TIntegerField
      DisplayLabel = 'Repeat'
      DisplayWidth = 10
      FieldName = 'HAWBS_REPEAT'
    end
  end
  ...
  object DetailSQL: TIBCQuery
    KeyFields = 'SERIAL_NUMBER'
    KeyGenerator = 'GEN_XML_FILE_INFO_ITEMS_ID'
    SQLInsert.Strings = (
      'INSERT INTO DUTY_RELIEVE_ITEM'
      
        '  (SERIAL_NUMBER, FK_DUTY_RELIEVE, FK_DUTY_TYPE, PERCENTAGE_RELI' +
        'EVE)'
      'VALUES'
      
        '  (:SERIAL_NUMBER, :FK_DUTY_RELIEVE, :FK_DUTY_TYPE, :PERCENTAGE_' +
        'RELIEVE)')
    SQLDelete.Strings = (
      'DELETE FROM DUTY_RELIEVE_ITEM'
      'WHERE'
      '  SERIAL_NUMBER = :Old_SERIAL_NUMBER')
    SQLUpdate.Strings = (
      'UPDATE DUTY_RELIEVE_ITEM'
      'SET'
      
        '  SERIAL_NUMBER = :SERIAL_NUMBER, FK_DUTY_RELIEVE = :FK_DUTY_REL' +
        'IEVE, FK_DUTY_TYPE = :FK_DUTY_TYPE, PERCENTAGE_RELIEVE = :PERCEN' +
        'TAGE_RELIEVE'
      'WHERE'
      '  SERIAL_NUMBER = :Old_SERIAL_NUMBER')
    SQLRefresh.Strings = (
      
        'SELECT SERIAL_NUMBER, FK_DUTY_RELIEVE, FK_DUTY_TYPE, PERCENTAGE_' +
        'RELIEVE FROM DUTY_RELIEVE_ITEM'
      'WHERE'
      '  SERIAL_NUMBER = :SERIAL_NUMBER')
    SQLLock.Strings = (
      'SELECT NULL FROM DUTY_RELIEVE_ITEM'
      'WHERE'
      'SERIAL_NUMBER = :Old_SERIAL_NUMBER'
      'FOR UPDATE WITH LOCK')
    SQLRecCount.Strings = (
      'SELECT COUNT(*) FROM ('
      'SELECT 1 AS C  FROM DUTY_RELIEVE_ITEM'
      ''
      ') q')
    Connection = ClairDML.CabCOnnection
    Transaction = ReadTrans
    ...
    DetailFields = 'FK_XML_FILE_INFO_SERIAL'
    ...
    object DetailSQLHAWB_ID: TStringField
      DisplayLabel = 'Hawb Id'
      DisplayWidth = 24
      FieldName = 'HAWB_ID'
      Size = 50
    end
    object DetailSQLITEM_MESSAGE: TStringField
      DisplayLabel = 'Error Message'
      DisplayWidth = 172
      FieldName = 'ITEM_MESSAGE'
      Size = 800
    end
    object DetailSQLFK_XML_FILE_INFO_SERIAL: TIntegerField
      FieldName = 'FK_XML_FILE_INFO_SERIAL'
      Visible = False
    end
  end
