unit I_ReadMediumTariffsExempt;
...
type
  TI_ReadMediumTariffsExemptFRM = class(TForm)
    Panel1: TPanel;
    Panel2: TPanel;
    BitBtn1: TBitBtn;
    Panel3: TPanel;
...
Var
  I_ReadMediumTariffsExemptFRM: TI_ReadMediumTariffsExemptFRM;
...
procedure TI_ReadMediumTariffsExemptFRM.Split(Delimiter: Char; Str: string; ListOfStrings: TStrings);
  begin
    ListOfStrings.Clear;
...
procedure TI_ReadMediumTariffsExemptFRM.ReadFileBTNxClick(Sender: TObject);
  Const
    Qt = '"';
  Var
...
procedure TI_ReadMediumTariffsExemptFRM.FormCreate(Sender: TObject);
  begin
    cn := ClairDML.CabCOnnection;
  end;

procedure TI_ReadMediumTariffsExemptFRM.Button1Click(Sender: TObject);
  begin
...
procedure TI_ReadMediumTariffsExemptFRM.BitBtn2Click(Sender: TObject);
  begin
    close;
  end;
