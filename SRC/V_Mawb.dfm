object V_MawbFRM: TV_MawbFRM
  ...
  object MawbPC: TPageControl
    ...
    object MawbDetailsTS: TTabSheet
      ...
      object Panel2: TPanel
        ...
        object FromBucketBtn: TRzBitBtn
          Left = 999
          Top = 4
          Width = 53
          Height = 37
          FrameColor = clInfoText
          Caption = 'Fetch  Buckets'
          Color = clYellow
          TabOrder = 7
          Visible = False
          OnClick = FromBucketBtnClick
          Glyph.Data = {
            F6060000424DF606000000000000360000002800000018000000180000000100
            180000000000C006000000000000000000000000000000000000FFFFFFFFFFFF
            FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
      ...
      object LowPanexPNL: TRzPanel
        ...
        object MhawbsGRD: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'CUSTOMER_NAME'#9'23'#9'Customer Name'#9#9
            'WEIGHT'#9'9'#9'Weight'#9#9
            'WEIGHT_GROSS'#9'10'#9'Gross'#9#9
            'PRE_DISCOUNT_AMOUNT'#9'12'#9'Inv Amount'#9#9
            'CURRENCY'#9'10'#9'Currency'#9#9
            'SENDERCUSTOMVALUE'#9'14'#9'Customs Val'#9#9)
          IniAttributes.Delimiter = ';;'
          IniAttributes.UnicodeIniFile = False
          ...
          Options = [dgAlwaysShowEditor, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgAlwaysShowSelection, dgConfirmDelete, dgCancelOnExit, dgWordWrap, dgMultiSelect, dgShowFooter]
          ParentCtl3D = False
          ParentFont = False
          ReadOnly = True
          TabOrder = 1
    ...
    object SavedTs: TTabSheet
      ...
      object LowGRD: TwwDBGrid
        ...
        ControlType.Strings = (
          ...
          'FK_CLEARING_STATE;CheckBox;1;0')
        Selected.Strings = (
          'HAB_ID'#9'13'#9'Hawb'#9#9
          'DESCRIPTION'#9'25'#9'Description'#9#9
          'CUSTOMER_NAME'#9'16'#9'Customer'#9#9
          'FK_CLEARING_STATE'#9'3'#9'Clr'#9#9
          'FK_INVOICE_STATUS'#9'3'#9'Inv'#9#9
          'INVOICE_AMOUNT'#9'9'#9'Invoice~Amount'#9#9
          'CURRENCY'#9'5'#9'Cur'#9#9)
        IniAttributes.Delimiter = ';;'
        IniAttributes.UnicodeIniFile = False
        TitleColor = clBtnFace
        FixedCols = 0
    ...
    object BucketHawbsTS: TTabSheet
      Caption = 'Bucket Hawbs'
      ImageIndex = 5
      OnEnter = BucketHawbsTSEnter
      ...
      object RzPanel8: TRzPanel
        ...
        object wwDBGrid3: TwwDBGrid
          ...
          Selected.Strings = (
            'SERIAL_NUMBER'#9'10'#9'* S/N'#9#9
            'HAB_ID'#9'14'#9'Hawb'#9#9
            'XML_HOUSE_ID'#9'16'#9'TDID'#9#9
            'FK_CLEARANCE_INSTRUCTION'#9'7'#9'Type'#9#9
            'CLEARANCE_WAITING_CODE'#9'5'#9'Status'#9#9
            'FK_CLEARING_STATE'#9'3'#9'Clr'#9#9
            'FK_INVOICE_STATUS'#9'3'#9'Inv'#9#9
            'DESCRIPTION'#9'24'#9'Description'#9#9
            ...
            'INVOICE_AMOUNT_CYP'#9'10'#9'Amount Euro'#9#9
          ...
          Align = alLeft
          Ctl3D = False
          DataSource = V_MawbDataDML.BucketPendingSRC
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'Arial'
  ...
  object MainMenu1: TMainMenu
    ...
    object Reports1: TMenuItem
      ...
      object MediumH7Declarations1: TMenuItem
    ...
    object XML1: TMenuItem
      ...
      object CreateMediumXMLWarehouse1: TMenuItem
        Caption = 'Create Medium XML Warehouse '
        OnClick = CreateMediumXMLWarehouse1Click
      end
    end
    ...
    object Buckets1: TMenuItem
      Caption = 'Buckets'
      object FetchBuckets1: TMenuItem
        Caption = 'Fetch Buckets'
        OnClick = FetchBuckets1Click
      end
    end
  end
  ...
  object DbImages: TImageList
    ...
    Top = 29
    Bitmap = {
      494C010118008800040010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object BindingsList1: TBindingsList
    ...
    object LinkPropertyToFieldFK_CLEARING_STATE: TLinkPropertyToField
      ...
      Component = clrLbl
      ComponentProperty = 'Hint'
    end
  end
  object BindSourceDB2: TBindSourceDB
    DataSet = V_MawbDataDML.HawbSQL
    ScopeMappings = <>
    Left = 144
    Top = 8
  end
